...
class QwenClient:
    def __init__(self, base_url="http://127.0.0.1:11434", model="", timeout=30,
                 opener=None, keep_alive="30m", think=False, num_predict=256):
        ...
        # Ollama counts hidden reasoning tokens against num_predict as well.  A
        # very small cap can therefore finish with an empty message even when
        # thinking was requested off (older/model-specific builds may ignore it).
    ...
    def chat(self, text, image=None, system_prompt="", cancel_event=None):
        ...
        try:
            ...
            while True:
                ...
                if isinstance(content, str) and content: pieces.append(content)
