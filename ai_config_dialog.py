...
class AIConfigDialog:
    ...
    def _build(self, ai):
        ...
        self.system = tk.Text(sysbox, height=4)
        ...
        self.profile_tree = ttk.Treeview(pbox, columns=("enabled", "name"), show="headings", height=4); self.profile_tree.heading("enabled", text="狀態"); self.profile_tree.heading("name", text="名稱"); self.profile_tree.grid(row=0, column=0, sticky="nsew")
